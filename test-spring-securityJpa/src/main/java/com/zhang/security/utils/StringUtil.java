...
public class StringUtil {
	...
	public static String getURLEncoder(String content) {
    	...
    	try{
    		strContent = java.net.URLEncoder.encode(content,WebAppConfig.ENCODING_UTF8);
    	}catch(Exception e){
    		strContent = "";
    	}
    	return strContent;
	...
	public static String getURLDecoder(String content) {
    	...
    	try{
    		strContent = java.net.URLDecoder.decode(content,WebAppConfig.ENCODING_UTF8);
    	}catch(Exception e){
    		strContent = "";
    	}
    	return strContent;
   ...
   */
   ...
   public static String replaceUbb(String content) { 
	 ...
	 * add by: houxu@xwtec.cn
	 */
	public static Object changeNullToEmpty(Object obj) {
	 ...
	 * @return
	 */
	public static String stringFormat(String str,String... params){
